          ...
          {steps.map((item, index) => {
            return (
              <div
                ...
                key={index}
              >
                <div className=" transition-all duration-200 opacity-0 group-hover:opacity-100 absolute inset-0 rounded-lg bg-gradient-to-br from-primary to-sky-300"></div>
                <div className="relative pb-8">
                  <div className=" text-5xl mb-12 bg-gradient-to-br from-primary to-sky-300 inline-block text-transparent bg-clip-text group-hover:text-cyan-50">
